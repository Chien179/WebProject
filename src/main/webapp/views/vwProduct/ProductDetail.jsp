    ...
    <jsp:body>
        <div class="container-fluid bg-light">
            <div class="row mt-3">
                ...
                <div class="col-md-7">
                    <div class="row">
                        <div class="d-flex card-header h-auto bg-white border">
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">shop bán điện thoại đâm thằng tên Trí</p>
            ...
            <div class="row">
                <div class="col-md-9">
                    <div class="row h-auto w-auto">
                        ...
                        <ul class="list-group list-group-flush w-100 mx-4">
                    ...
                    <div class="row h-auto w-auto">
                        ...
                        <div class="d-flex bg-white mx-4">
                            <p>
