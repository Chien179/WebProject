                                ...
                                <div class="d-flex">
                                    <c:forEach begin="0" end="4" varStatus="loop" var="i">
                                        <div class="card card card-hover border-secondary h-60" style="width: 225px; margin: 10px 0px 10px 20px; box-sizing: border-box; height: 300px;">
                                            ...
                                            <div class="card-body">
                                                <h5 class="card-title pt-0 txtOverflow" style="color: #337ab7; font-size: 20px">${products[i].proName}</h5>
                                                <p class="card-text card-text-config" style="font-size: 6px; font-weight: bold">Ngày đăng: ${products[i].startDateTime}</p>
                                                <p class="card-text card-text-config" style="font-size: 7px">BID HIỆN TẠI <span class="float-end">THỜI GIAN CÒN LẠI</span></p>
                                                <p class="card-text card-text-config martop" style="font-size: 8px; color: green; font-weight: bold"><fmt:formatNumber value="${products[i].price}" type="currency"/>
                            ...
                            <div class="row w-82">
                                ...
                                <div class="d-flex">
                                    <c:forEach begin="0" end="4" varStatus="loop">
                                        <div class="card card border-secondary h-60" style="width: 225px; margin: 10px 0px 10px 20px; box-sizing: border-box; height: 300px;">
                                            <img src="${pageContext.request.contextPath}/Img/download.png" style="padding: 20px 10px 0px 12px" alt="House">
                                            <div class="card-body">
                                                <h5 class="card-title pt-0 txtOverflow" style="color: #337ab7; font-size: 20px">Hollow Knight</h5>
                ...
                <c:forEach begin="0" end="14" varStatus="loop" var="i">
                    <div class="card card border-secondary h-60" style="width: 350px; margin: 10px 0px 10px 20px; box-sizing: border-box; height: 400px;">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text card-text-config martop" style="font-size: 16px; font-weight: bold">10<span class="float-end"></span></p>
                        </div>
                    </div>
                </c:forEach>
            </div>
